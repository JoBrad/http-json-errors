...
const HttpError_2 = require("./HttpError");
...
function createError(status, message) {
    let statusCode = HttpError_2.getStatusCode(status);
    if (statusCode && CODE_CLASSES['' + statusCode]) {
        return new CODE_CLASSES['' + statusCode](message);
    }
    else {
        return new HttpError_2.HttpError({ status: status, message: message });
    }
}
 ...
 *
 */
class BadRequest extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 400,
        ...
        Object.assign(this, HttpError_2.parseErrorOptions(...options));
    }
}
 ...
 *
 */
class Unauthorized extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 401,
 ...
 *
 */
class Forbidden extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 403,
 ...
 *
 */
class NotFound extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 404,
 ...
 *
 */
class MethodNotAllowed extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 405,
 ...
 *
 */
class NotAcceptable extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 406,
 ...
 *
 */
class ProxyAuthenticationRequired extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 407,
 ...
 *
 */
class RequestTimeout extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 408,
 ...
 *
 */
class Conflict extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 409,
 ...
 *
 */
class Gone extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 410,
 ...
 *
 */
class LengthRequired extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 411,
 ...
 *
 */
class PreconditionFailed extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 412,
 ...
 *
 */
class PayloadTooLarge extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 413,
 ...
 *
 */
class URITooLong extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 414,
 ...
 *
 */
class UnsupportedMediaType extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 415,
 ...
 *
 */
class RangeNotSatisfiable extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 416,
 ...
 *
 */
class ExpectationFailed extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 417,
 ...
 *
 */
class ImATeapot extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 418,
 ...
 *
 */
class MisdirectedRequest extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 421,
 ...
 *
 */
class UnprocessableEntity extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 422,
 ...
 *
 */
class Locked extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 423,
 ...
 *
 */
class FailedDependency extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 424,
 ...
 *
 */
class TooEarly extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 426,
 ...
 *
 */
class UpgradeRequired extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 426,
 ...
 *
 */
class PreconditionRequired extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 428,
 ...
 *
 */
class TooManyRequests extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 429,
 ...
 *
 */
class RequestHeaderFieldsTooLarge extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 431,
 ...
 *
 */
class UnavailableForLegalReasons extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 451,
 ...
 *
 */
class InternalServerError extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 500,
 ...
 *
 */
class NotImplemented extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 501,
 ...
 *
 */
class BadGateway extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 502,
 ...
 *
 */
class ServiceUnavailable extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 503,
 ...
 *
 */
class GatewayTimeout extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 504,
 ...
 *
 */
class HTTPVersionNotSupported extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 505,
 ...
 *
 */
class VariantAlsoNegotiates extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 506,
 ...
 *
 */
class InsufficientStorage extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 507,
 ...
 *
 */
class NetworkAuthenticationRequired extends HttpError_2.HttpError {
    constructor(...options) {
        super({
            "status": 511,
